! function (e, t) {
    function n() {
        ...
        '<div class="sweet-alert" tabIndex="-1">'+
            ...
            '<button class="confirm" id="okbtn" tabIndex="1">OK</button></div>',
        ...
        if (o.innerHTML = b(t.title).split("\n").join("<br>"), r.innerHTML = b(t.text || "").split("\n").join("<br>"), t.text && w(r), x(n.querySelectorAll(".icon")), t.type) {
            ...
            switch (w(u), t.type) {
                ...
                case "error":
                    ...
                    break;
                case "warning":
                    g(u, "pulseWarning"), g(u.querySelector(".wbody"), "pulseWarningIns"), g(u.querySelector(".dot"), "pulseWarningIns")
            }
        }
        if (t.imageUrl) {
    ...
    function l() {
        ...
        // v(a, "pulseWarning"), v(a.querySelector(".wbody"), "pulseWarningIns"), v(a.querySelector(".dot"), "pulseWarningIns"), e.onkeydown = M, t.onclick = A, I && I.focus(), L = void 0
    }
